...
def main():
    ...
    api_base = "http://provider.a100.hou3.dd.akash.pub:32248/v1"
    response_column = "mistral_nemo_response"
    answer_key = response_column
    label_key = "mistral_nemo_score"
    explanation_key = "mistral_nemo_explanation"
    precision_key = "mistral_nemo_precision-precision"
    number_of_parameters_key = "mistral_nemo_number_of_parameters"
    number_of_parameters = "12b"
    ...
    save_intermediate_dataset(dataset_df, "intermediate_mistral_nemo.json")
