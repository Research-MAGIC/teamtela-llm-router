...
def main():
    ...
    response_column = "llama3_1_8b_response"
    answer_key = response_column
    label_key = "llama3_1_8b_score"
    explanation_key = "llama3_1_8b_explanation"
    precision_key = "llama3_1_8b_precision"
    number_of_parameters_key = "llama3_1_8b_number_of_parameters"
    number_of_parameters = "8b"
    ...
    save_intermediate_dataset(dataset_df, "intermediate_llama3_1_8b.json")
